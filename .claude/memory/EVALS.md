...
- **Arbitrage de produit tracé :** un vecteur alternatif donne **83,06 h** cumulées et la zone 142
  ...
  contraintes. Levier de rallonge sans code, si besoin plus tard : adoucir `g` (1,21 → 1,10 double presque
  la durée d'un run), monter le couple vers 5 × 6 = 30, étaler le contenu par zone.
