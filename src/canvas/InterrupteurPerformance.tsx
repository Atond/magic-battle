...
export function InterrupteurPerformance({
  ...
  return (
    <button
      ...
      onClick={basculer}
      className="min-h-6 min-w-6 rounded-full border border-[var(--couleur-charbon-bordure)] bg-[var(--couleur-charbon-800)] px-2 py-1 text-[10px] font-medium text-[var(--couleur-charbon-texte)] hover:bg-[var(--couleur-charbon-700)] aria-checked:bg-[var(--couleur-ecole-feu)]"
    >
